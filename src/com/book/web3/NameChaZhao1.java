...
public class NameChaZhao1 extends HttpServlet  {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {  
    	try {
        	...
        	String sql = "select * from grades where grades.name like '%"+name2+"%';";
    	...
    	request.getRequestDispatcher("namechazhaogrades1.jsp").forward(request, response);
    }        
    /** 
     * 销毁 
     */  
